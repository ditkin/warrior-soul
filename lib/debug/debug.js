...
const createEntityPanel = instance => {
  ...
  entityPanel.addOption(
    new DebugOption('Show Collision Boxes', DebuggableEntity, '_debugShowBoxes')
  )
  entityPanel.addOption(
    new DebugOption('Show Velocities', DebuggableEntity, '_debugShowVelocities')
  )
  entityPanel.addOption(
    new DebugOption('Show Names & Targets', DebuggableEntity, '_debugShowNames')
  )
  return entityPanel
}
